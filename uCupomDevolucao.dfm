object fCupomDevolucao: TfCupomDevolucao
  Left = 280
  Top = 126
  Width = 900
  Height = 452
  BorderIcons = [biSystemMenu, biMaximize]
  Caption = 'fCupomDevolucao'
  Color = clBtnFace
    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object pnlCadastro: TPanel
        ...
        object SMDBGrid2: TSMDBGrid
          ...
          Ctl3D = True
          DataSource = dmDevolucao.dsDevolucaoItens
          Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit]
          ParentCtl3D = False
          ReadOnly = True
          TabOrder = 8
        ...
        object RxDBLookupCombo1: TRxDBLookupCombo
          ...
          LookupField = 'ID'
          LookupDisplay = 'NOME'
          LookupSource = dmDevolucao.dsFilial
          TabOrder = 0
