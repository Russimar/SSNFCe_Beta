...
begin
  if not (fDMCadFechamento.cdsFechamento_San.IsEmpty) then
  begin
...
procedure TfrmCadFechamento.SpeedButton5Click(Sender: TObject);
begin
  ffrmCadFechamento_Sangria := TfrmCadFechamento_Sangria.Create(self);
  ffrmCadFechamento_Sangria.fDMCadFechamento := fDMCadFechamento;
  vID_Fechamento_Pos := fDMCadFechamento.cdsFechamentoID.AsInteger;
...
procedure TfrmCadFechamento.SpeedButton6Click(Sender: TObject);
begin
  ffrmCadFechamento_Sangria := TfrmCadFechamento_Sangria.Create(self);
  ffrmCadFechamento_Sangria.fDMCadFechamento := fDMCadFechamento;
  vID_Fechamento_Pos := fDMCadFechamento.cdsFechamentoID.AsInteger;
